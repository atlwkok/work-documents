...
-- To execute this hardcoded sql in MySQL Workbench, replace %(orgId)s with 'LIV' and %% with %
-- To execute this hardcoded sql in MySQL Workbench, replace %(orgId)s with 'LIV' and %% with %
-- To execute this hardcoded sql in MySQL Workbench, replace %(orgId)s with 'LIV' and %% with %
-- To execute this hardcoded sql in MySQL Workbench, replace %(orgId)s with 'LIV' and %% with %
with
...
-- Changes for UPDATE SQL statement to be able to insert query into PostgreSQL without issues
-- Changes for UPDATE SQL statement to be able to insert query into PostgreSQL without issues
-- Changes for UPDATE SQL statement to be able to insert query into PostgreSQL without issues
-- Changes for UPDATE SQL statement to be able to insert query into PostgreSQL without issues
